    ...
    <div>
        ...
        <section class="relative md:py-24 py-16">
            <div class="container relative">
                ...
                <div id="grid" class="lg:columns-4 md:columns-3 columns-1 gap-4 mx-auto mt-4">
                    <div v-for="(item, index) in filteredData" :key="index" class="picture-item mb-4">
                        <div class="group relative block overflow-hidden rounded-md duration-500">
                            ...
                            <div
                                class="absolute -bottom-52 group-hover:bottom-2 start-2 end-2 duration-500 bg-white dark:bg-slate-900 p-4 rounded shadow-sm dark:shadow-gray-800">
