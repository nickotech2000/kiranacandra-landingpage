<template>
    <div>
        ...
        <section class="relative md:h-screen flex items-center py-36 overflow-hidden">
            ...
            <!-- <span class="absolute bottom-40 xl:start-[45rem] xl:w-[90rem] xl:h-[35rem] ltr:rotate-[115deg] rtl:rotate-[65deg] bg-red-600 md:start-40 w-[75rem] h-[30rem]"></span> -->
...
import image from '@/assets/images/kirana/1.png';
import image2 from '@/assets/images/kirana/2.png';
import image3 from '@/assets/images/kirana/3.png';
import image4 from '@/assets/images/kirana/4.png';
import image5 from '@/assets/images/kirana/5.png';
import image6 from '@/assets/images/kirana/6.png';
import image7 from '@/assets/images/kirana/7.png';
import image8 from '@/assets/images/kirana/8.png';
import image9 from '@/assets/images/kirana/9.png';
import image10 from '@/assets/images/kirana/10.png';
import image11 from '@/assets/images/kirana/11.png';

import logo from '@/assets/images/kirana-candra-tech-logo.png';

// import Navbar from '@/components/navbar/navbar.vue';
import Experience from '@/components/startup/startup-experience.vue';
import Iframe from '@/components/startup/it-solution-iframe.vue';
...
const backgroundImages = [image, image2, image3, image4, image5,image6, image7, image8, image9,image10, image11];
const datas = ref([
  {
    icon: 'uil uil-plane-departure',
    name: 'Hospitality Service',
    desc: 'Focus on your travel and activity while we do the rest'
  },
  {
    icon: 'uil-bitcoin-circle',
    name: 'Web3',
    desc: 'Payment, NFT and RWA'
  },
  {
    icon: 'uil uil-focus-target',
    name: 'Intelligence Ecosystem',
    desc: 'Benefit from automation and AI'
  }
]);
