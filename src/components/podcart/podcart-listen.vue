                ...
                <div class="grid md:grid-cols-12 grid-cols-1 items-center md:gap-[30px] gap-12">
                    <div class="md:col-span-5">
                        <div class="relative">
                            <div class="shadow-md dark:shadow-gray-800 rounded-t-full border-8 border-gray-200 dark:border-gray-900">
                                <img :src="about" class="shadow-md rounded-t-full" alt="">
                            </div>
                                    ...
                                    <div class="p-6 space-y-6">
                                        ...
                                        <div class="space-y-2">
                                            <div class="relative">
                                                ...
                                                <div class="ring-indigo-600 ring-2 absolute left-1/2 top-1/2 size-4 -mt-2 -ml-2 flex items-center justify-center bg-white rounded-full shadow">
                    ...
                    <div class="md:col-span-7">
                        <div class="lg:ms-4">
                            ...
                            <div class="mt-4">
                                <router-link to="#" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md mt-3">Learn More </router-link>
                            </div>
                        </div>
                    </div>
                </div>
...
<script setup>
import about from '@/assets/images/podcast/ab.jpg'
