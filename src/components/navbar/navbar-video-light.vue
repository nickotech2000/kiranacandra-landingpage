        ...
        <div class="container relative">
            ...
            <div id="navigation" :class="toggle === false ? 'hidden' : 'block'">
                <ul class="navigation-menu nav-light !justify-end">
                    <li :class="activeMenu === '/index-video' ? 'active' : ''"><router-link to="/index-video" class="sub-menu-item">Home</router-link></li>

                    <li :class="activeMenu === '/video-portfolio' ? 'active' : ''"><router-link to="/video-portfolio" class="sub-menu-item">Videos</router-link></li>
                    <li><router-link to="" class="sub-menu-item">Studio</router-link></li>
                    <li :class="activeMenu === '/contact-two' ? 'active' : ''"><router-link to="/contact-two" class="sub-menu-item">Contact Us</router-link></li>
                </ul>
            </div>
        </div>
    </nav>
