                        ...
                        <div class="lg:col-start-2 lg:col-span-10">
                            <div class="relative">
                                ...
                                <div class="absolute bottom-2/4 translate-y-2/4 start-0 end-0 text-center">
                                    <router-link to="#" @click="toggle" data-type="youtube" data-id="S_CGed6E610" class="lightbox size-20 rounded-full shadow-lg dark:shadow-gray-800 inline-flex items-center justify-center bg-white dark:bg-slate-900 text-indigo-600 dark:text-white cursor-pointer"><i class="mdi mdi-play inline-flex items-center justify-center text-2xl"></i></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="grid md:grid-cols-2 grid-cols-1 items-center">
                                    ...
                                    <div class="mt-8">
                                        <div class="section-title text-md-start">
                                            ...
                                            <router-link to="#" class="text-white">Read More <i class="uil uil-angle-right-b align-middle"></i></router-link>
                                        </div>
                                    </div>
                                </div>
                            </div>
