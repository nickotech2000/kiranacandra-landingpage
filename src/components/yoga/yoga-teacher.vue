            ...
            <div v-for="teacher in teachers" :key="teacher" class="lg:col-span-3 md:col-span-6">
                <div class="group text-center">
                    ...
                    <div class="content mt-3">
                        <router-link to="#" class="text-lg font-semibold hover:text-indigo-600 duration-500">{{ teacher.name }}</router-link>
...
<script setup>
import team1 from '@/assets/images/yoga/t01.jpg'
import team2 from '@/assets/images/yoga/t02.jpg'
import team3 from '@/assets/images/yoga/t03.jpg'
import team4 from '@/assets/images/yoga/t04.jpg'
