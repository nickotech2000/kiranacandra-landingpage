        ...
        <div class="grid md:grid-cols-3 grid-cols-1 mt-8 gap-[30px] items-center">
            <div class="p-6">
                <div class="pb-8">
                    ...
                    <router-link to="#" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600/5 hover:bg-indigo-600 border-indigo-600/10 hover:border-indigo-600 text-indigo-600 hover:text-white rounded-md w-full">Redeem Now</router-link>
                </div>
            ...
            <div class="shadow-sm rounded-md p-6 bg-gradient-to-t bg-indigo-600">
                <div class="pb-8">
                    ...
                    <router-link to="#" class="py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-orange-500 hover:bg-orange-600 border-orange-500 hover:border-orange-600 text-white rounded-md w-full">Started Now</router-link>
                </div>
            ...
            <div class="p-6">
                <div class="pb-8">
                    ...
                    <router-link to="#" class="py-2 px-5 inline-block tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md w-full">Signup Now</router-link>
                </div>
                <div class="border-b border-slate-200 dark:border-slate-200/5"></div>
                <ul class="self-start pt-8">
                    <li class="flex items-center mb-1 text-slate-400">
